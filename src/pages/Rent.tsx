...
const Rent = () => {
  ...
  useEffect(() => {
    const queryFilters = { transaction_type: "rent" };
  ...
  const filteredProperties = useMemo(() => {
    ...
    let filtered = properties.filter((p) => p.transaction_type === "rent");
    if (filters.search) {
      ...
      >
        <div className="container mx-auto px-4 text-center animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-neutral-200 max-w-3xl mx-auto mb-8">
            Explore quality rental properties in the best locations.
          </p>
          <Card className="max-w-4xl mx-auto bg-background/90 backdrop-blur-sm p-4 shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
              <div className="md:col-span-2">
                ...
                <Input
                  id="hero-search"
                  placeholder="e.g. 'Pune', 'Apartment', '2 BHK'"
              ...
              <Button size="lg" className="w-full">
                <Search className="w-5 h-5 mr-2" /> Find a Rental
              </Button>
            </div>
          </Card>
        </div>
            ...
            <main className="lg:col-span-3">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-foreground">
                  {isLoading
                    ? "Searching..."
                    : `${filteredProperties.length} Rental${filteredProperties.length !== 1 ? "s" : ""} Found`}
                </h2>
