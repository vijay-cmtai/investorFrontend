...
import { Search, Key, X, ListFilter } from "lucide-react";
...
const PropertiesPage = () => {
  ...
  const [filters, setFilters] = useState<Partial<FilterState>>(() => {
    ...
    return initialType ? { property_type: initialType } : {};
  });
  ...
  return (
    <div className="min-h-screen bg-muted/20">
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(28, 35, 48, 0.85), rgba(28, 35, 48, 0.85)), url(${heroBackgroundImage})`,
        }}
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-neutral-200 max-w-3xl mx-auto mb-8"
          >
          ...
          <Card className="max-w-4xl mx-auto bg-background/90 backdrop-blur-sm p-4 shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
              <div className="md:col-span-2">
                <Label
                  htmlFor="hero-search"
                  className="text-left block mb-2 font-semibold text-foreground"
                >
                  Location or Keyword
                </Label>
                <Input
                  id="hero-search"
                  placeholder="e.g. 'Mumbai', 'Sea View', 'Agriculture'"
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    {/* Yahan se empty value wala item hata diya hai */}
    ...
    <CardContent className="space-y-4">
      <div>
        ...
        >
          ...
          <SelectContent>
            {/* Yahan se bhi empty value wala item hata diya hai */}
...
const SkeletonCard = () => (
  <Card className="animate-pulse overflow-hidden rounded-xl">
